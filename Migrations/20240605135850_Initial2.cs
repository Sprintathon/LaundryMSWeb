    ...
    public partial class Initial2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    VisitResourcesId = table.Column<int>(type: "int", nullable: false),
                    VisitsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResourceVisit", x => new { x.VisitResourcesId, x.VisitsId });
                    table.ForeignKey(
                        name: "FK_ResourceVisit_Resources_VisitResourcesId",
                        column: x => x.VisitResourcesId,
                        principalTable: "Resources",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ResourceVisit_Visits_VisitsId",
                        column: x => x.VisitsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResourceVisit_VisitsId",
                table: "ResourceVisit",
                column: "VisitsId");
